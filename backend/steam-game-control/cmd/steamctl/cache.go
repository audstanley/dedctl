...
Examples:
  steamctl cache-images                # cache all games in metadata
  steamctl cache-images csgo rust      # cache specific games
  steamctl cache-images --force        # re-download all images even if cached`,
